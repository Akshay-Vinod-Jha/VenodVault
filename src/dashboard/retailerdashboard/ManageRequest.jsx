      ...
      return (
        ...
        >
          ...
          <div className="space-y-1">
            <h1 className="text-xl font-bold text-yellow-300">Request Info</h1>
            <p>
              <strong>Product ID:</strong> {safeValue(req.id)}
            </p>
            <p>
              <strong>Name:</strong> {safeValue(req.name)}
            </p>
            <p>
              <strong>Brand:</strong> {safeValue(req.brand)}
            </p>
            <p>
              <strong>Selling Price:</strong> {safeValue(req.sellingPrice)}
            </p>
            <p>
            ...
            <p>
              <strong>Expiry Date:</strong> {safeValue(req.expiryDate)}
            </p>
            <p>
  ...
  return (
    <div className="p-6 text-white min-h-screen bg-gray-900">
      <div className="max-w-7xl mx-auto">
        <h2 className="text-2xl font-bold mb-6">Manage Retailer Requests</h2>
